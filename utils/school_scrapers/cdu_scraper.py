# utils/school_scrapers/cdu_scraper.py
...
def scrape_cdu_data(base_url, school_name):
    """
    成都大学的爬虫函数。
    """
    print(f"  [{school_name}] 开始为成都大学抓取数据...")
    school_update_data = {
        "departments": [],
        "major_catalog_url": "", 
        "score_line_url": ""     
    ...
    catalog_keywords = ["硕士专业目录", "招生专业目录", "招生简章", "硕士研究生招生"]
    score_keywords = ["硕士复试分数线", "历年分数线", "复试线", "调剂复试"]
    ...
    # TODO: 实现成都大学特定的专业目录页面解析逻辑
    # ...

    # TODO: 实现成都大学特定的分数线页面解析逻辑
    # ...
            
    print(f"  [{school_name}] 成都大学数据抓取完成 (占位符)。")
